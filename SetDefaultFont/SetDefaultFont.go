...
func main() {
	...
	btn.Event_BnClick(func(pbHandled *bool) int {
		...
		w.MessageBox(fmt.Sprintf("fontName=%s, fontSize=%d, fontStyle=%d", uint16ToString(fontInfo.Name), fontInfo.NSize, fontInfo.NStyle), "Font Info", xcc.MessageBox_Flag_Ok)
		return 0
	})
